...
process_vars = {}
process_vars['proj'] = 'SOCRATES' # SOCRATES
...
process_vars['flight_time_start'] = datetime.timedelta(hours=1,minutes=10)
process_vars['flight_time_stop'] = datetime.timedelta(hours=3,minutes=20)

"""
Set up processint settings
"""
