...
def main():
    ...
    defaultGitDir = os.path.join(homeDir, "git/hsrl_configuration")
    ...
    parser.add_option('--dataDir',
                      dest='dataDir', default='/data/hsrl',
    ...
    # for now, only archiver is valid

    # hostTypes = [ 'archiver', 'instrument' ]
    hostTypes = [ 'archiver' ]
    ...
    # populate installed data dir /data/hsrl
